# -*- coding: utf-8 -*-
"""
Room Service API main module
"""
# Configure logging before any imports
from common.logger import get_logger

# Создаем базовый логгер для сервиса
logger = get_logger("room_service")
...
logger_cache = get_logger("room_service.cache")
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("[bold green]Room Service starting up...[/bold green]")
    ...
    logger.info("[bold yellow]Room Service shutting down...[/bold yellow]")
