...
class Settings(BaseServiceSettings):
    ...
    """
    # Общие настройки
    PROJECT_NAME: str = "CompEduX Course Service"
    DESCRIPTION: str = "Course management service for CompEduX Learning Platform"
    VERSION: str = "0.1.0"
    ...
    POSTGRES_USER: str = os.getenv("POSTGRES_USER", "course_user")
    POSTGRES_PASSWORD: str = os.getenv("POSTGRES_PASSWORD", "coursepassword123")
